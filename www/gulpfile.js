...
gulp.task('minify-bs-css', ['less'], function() {
...
// Run everything
gulp.task('default', ['less', 'minify-css', 'minify-bs-css', 'minify-js', 'copy']);
...
gulp.task('dev', ['browserSync', 'less', 'minify-css', 'minify-bs-css', 'minify-js'], function() {
